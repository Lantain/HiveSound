...
callbacks = [
  tf.keras.callbacks.EarlyStopping(monitor='val_accuracy', patience=2, start_from_epoch=3),
  tf.keras.callbacks.EarlyStopping(monitor='val_loss', patience=2, start_from_epoch=3),
  tf.keras.callbacks.EarlyStopping(monitor='accuracy', patience=2, start_from_epoch=3),
]